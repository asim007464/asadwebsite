  ...
  return (
    <main className="mx-auto flex min-h-[calc(100vh-var(--site-header-height)-6rem)] w-full max-w-md flex-col justify-center px-4 py-12">
      <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
        ...
        <h1 className="mt-2 text-2xl font-semibold tracking-tight text-slate-900">Reset password</h1>
        <p className="mt-2 text-sm text-slate-600">Enter the email on your account and we&apos;ll send you a reset link.</p>
        <ForgotPasswordForm />
      </div>
